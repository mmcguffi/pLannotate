...
def main_makedb(
    ...
    Creates a BLAST or DIAMOND search index, an optional SQLite descriptions
    database, and a ready-to-run YAML configuration. Annotate with the new source
    via 'plannotate batch -i seq.fa -y <yaml_out>'.
    """
    if verbose:
