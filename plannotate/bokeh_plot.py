...
def get_bokeh(df, linear):
    ...
    #C97064
    #C9E4CA
    fullColorDf=pd.read_csv(resources.get_resource("data", "colors.csv"),index_col=0)
    ...
    orient = pd.read_csv(resources.get_resource("data", "feature_orientation.csv"),header=None, names = ["Type","has_orientation"])
